# this code is from https://github.com/JonathanShor/DoubletDetection/blob/master/doubletdetection
...
import anndata
import numpy as np
# I deleted all code relelated to phenograph method
#import phenograph
import scanpy as sc
...
class BoostClassifier:
    ...
    def __init__(
        ...
        if self.clustering_algorithm not in ["louvain", "leiden"]:
            raise ValueError(
                "Clustering algorithm needs to be one of ['louvain', 'leiden']"
            )
